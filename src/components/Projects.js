...
const Projects = () => {
  ...
  const fetchProjects = async () => {
    try {
      ...
      const response = await axios.get('https://team-gamma-gold.vercel.app/api/projects', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://team-gamma-gold.vercel.app/api/projects', formData, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this project? This will also delete all tasks in this project.')) {
      try {
        const token = localStorage.getItem('token');
        await axios.delete(`https://team-gamma-gold.vercel.app/api/projects/${id}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
